...
| the same widget renders two ways | only `isAnimationActive={true}` can still do this; everything else is pinned |

Every build is published under three tags: the version (`1.3.0`), the commit it
